...
android {
  namespace = "com.aryaxzell.reminder"
  ...
  defaultConfig {
    applicationId = "com.aryaxzell.reminder"
    minSdk = 24
    targetSdk = 36
  ...
  signingConfigs {
    ...
    create("release") {
      ...
      if (releaseKeystore.exists()) {
        ...
        // Fallback to consistent keystore so release builds can also be installed and overwrite seamlessly
        storeFile = defaultDebugKeystore
        storePassword = "android"
        keyAlias = "androiddebugkey"
        keyPassword = "android"
