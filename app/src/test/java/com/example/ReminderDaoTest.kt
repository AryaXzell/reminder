...
class ReminderDaoTest {
    ...
    fun updateReminderCompletion() = runBlocking {
        val reminder = Reminder(title = "Task to complete", isCompleted = false)
    ...
    fun deleteReminder() = runBlocking {
        val reminder = Reminder(title = "Temporary Task")
        val id = dao.insertReminder(reminder).toInt()
    ...
    fun getPendingRemindersWithDueDate() = runBlocking {
        ...
        val pending1 = Reminder(title = "Future 1", dueDate = now + 10000, isCompleted = false)
        val pending2 = Reminder(title = "Future 2", dueDate = now + 20000, isCompleted = false)
        val completed = Reminder(title = "Completed Future", dueDate = now + 30000, isCompleted = true)
        val noDueDate = Reminder(title = "No Due Date", dueDate = null, isCompleted = false)
        ...
        val results = dao.getPendingRemindersWithDueDate(now)
